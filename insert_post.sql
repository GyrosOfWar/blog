...
INSERT INTO posts (title, content, id, created_on) VALUES
  ('A test blog post', 'This is the content of the test blog post', 1, now()),
  ('Another test blog post!', 'Some more #content #value', 2, now()),
  ('Post from User 2', 'Content of the post!', 3, now());
